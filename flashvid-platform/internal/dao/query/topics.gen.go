...
func newTopic(db *gorm.DB, opts ...gen.DOOption) topic {
	...
	_topic.Description = field.NewString(tableName, "description")
	_topic.CoverURL = field.NewString(tableName, "cover_url")
	_topic.ViewCount = field.NewInt64(tableName, "view_count")
	_topic.VideoCount = field.NewInt32(tableName, "video_count")
	_topic.Status = field.NewInt32(tableName, "status")
...
type topic struct {
	...
	Description field.String // 话题描述
	CoverURL    field.String // 话题封面
	ViewCount   field.Int64  // 浏览量
	VideoCount  field.Int32  // 视频数
...
func (t *topic) updateTableName(table string) *topic {
	...
	t.ViewCount = field.NewInt64(table, "view_count")
	t.VideoCount = field.NewInt32(table, "video_count")
...
func (t *topic) fillFieldMap() {
	...
	t.fieldMap["video_count"] = t.VideoCount
