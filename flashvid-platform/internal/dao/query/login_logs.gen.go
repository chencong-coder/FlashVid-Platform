...
func newLoginLog(db *gorm.DB, opts ...gen.DOOption) loginLog {
	...
	_loginLog.DeviceName = field.NewString(tableName, "device_name")
	...
	_loginLog.LoginType = field.NewInt32(tableName, "login_type")
...
type loginLog struct {
	...
	LoginType  field.Int32  // 登录方式：1-密码，2-短信，3-第三方
	Status     field.Int32  // 登录状态：1-成功，2-失败
...
func (l *loginLog) fillFieldMap() {
	...
	l.fieldMap["device_name"] = l.DeviceName
	l.fieldMap["os"] = l.Os
