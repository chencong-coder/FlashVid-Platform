...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.IPAddress = field.NewString(tableName, "ip_address")
	...
	_user.VideoCount = field.NewInt32(tableName, "video_count")
...
type user struct {
	...
	IPAddress      field.String // 注册IP
	Status         field.Int32  // 状态：1-正常，2-封禁
	FollowerCount  field.Int32  // 粉丝数
	FollowingCount field.Int32  // 关注数
	VideoCount     field.Int32  // 作品数
	LikeCount      field.Int32  // 获赞数
...
func (u *user) updateTableName(table string) *user {
	...
	u.VideoCount = field.NewInt32(table, "video_count")
