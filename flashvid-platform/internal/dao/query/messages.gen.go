...
func newMessage(db *gorm.DB, opts ...gen.DOOption) message {
	...
	_message.MediaURL = field.NewString(tableName, "media_url")
	_message.IsRead = field.NewInt32(tableName, "is_read")
...
type message struct {
	...
	MessageType field.Int32  // 消息类型：1-文本，2-图片，3-视频
	Content     field.String // 消息内容
	MediaURL    field.String // 媒体文件URL
...
func (m *message) updateTableName(table string) *message {
	...
	m.MediaURL = field.NewString(table, "media_url")
...
func (m *message) fillFieldMap() {
	...
	m.fieldMap["media_url"] = m.MediaURL
