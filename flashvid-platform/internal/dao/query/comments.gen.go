...
func newComment(db *gorm.DB, opts ...gen.DOOption) comment {
	...
	_comment.ReplyToUserID = field.NewInt64(tableName, "reply_to_user_id")
	_comment.Content = field.NewString(tableName, "content")
	_comment.LikeCount = field.NewInt32(tableName, "like_count")
	_comment.ReplyCount = field.NewInt32(tableName, "reply_count")
...
type comment struct {
	...
	ParentID      field.Int64  // 父评论ID，0为一级评论
	ReplyToUserID field.Int64  // 回复的用户ID
	Content       field.String // 评论内容
	LikeCount     field.Int32  // 点赞数
	ReplyCount    field.Int32  // 回复数
	Status        field.Int32  // 状态：1-正常，2-已删除，3-审核中
	IPAddress     field.String // 评论IP
...
func (c *comment) updateTableName(table string) *comment {
	...
	c.ReplyCount = field.NewInt32(table, "reply_count")
