...
const (
	...
	CodePlaylistNotExist     ResCode = 20016 // 播放列表不存在
	...
	CodeVideoNotFavorited    ResCode = 20020 // 视频未收藏，不能加入播放列表
