...
func newPlaylist(db *gorm.DB, opts ...gen.DOOption) playlist {
	...
	_playlist.ID = field.NewInt64(tableName, "id")
	_playlist.UserID = field.NewInt64(tableName, "user_id")
	...
	_playlist.DeletedAt = field.NewField(tableName, "deleted_at")
