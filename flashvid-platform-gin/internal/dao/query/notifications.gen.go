...
func newNotification(db *gorm.DB, opts ...gen.DOOption) notification {
	...
	_notification.ActorID = field.NewInt64(tableName, "actor_id")
	_notification.ActionType = field.NewInt32(tableName, "action_type")
	_notification.TargetType = field.NewInt32(tableName, "target_type")
	_notification.TargetID = field.NewInt64(tableName, "target_id")
	_notification.Content = field.NewString(tableName, "content")
	_notification.IsRead = field.NewInt32(tableName, "is_read")
...
type notification struct {
	...
	ALL        field.Asterisk
	ID         field.Int64  // ID
	UserID     field.Int64  // 通知接收者ID
	ActorID    field.Int64  // 触发者ID
	ActionType field.Int32  // 1=关注 2=点赞视频 3=收藏视频 4=评论视频 5=回复评论
	TargetType field.Int32  // 1=用户 2=视频 3=评论
	TargetID   field.Int64  // 目标对象ID
	Content    field.String // 附加内容
	IsRead     field.Int32  // 0=未读 1=已读
...
func (n *notification) updateTableName(table string) *notification {
	...
	n.ActionType = field.NewInt32(table, "action_type")
	n.TargetType = field.NewInt32(table, "target_type")
	n.TargetID = field.NewInt64(table, "target_id")
	n.Content = field.NewString(table, "content")
	n.IsRead = field.NewInt32(table, "is_read")
...
func (n *notification) fillFieldMap() {
	...
	n.fieldMap["target_type"] = n.TargetType
